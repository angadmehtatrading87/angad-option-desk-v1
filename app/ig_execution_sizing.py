...
def get_execution_sizing_plan(now=None):
    ...
    try:
        ...
        v2_plan = build_agent_v2_plan() or {}
        v2_deployment = v2_plan.get("deployment") or {}
        v2_deployment_mode = str(v2_deployment.get("mode") or "").upper()
        v2_candidates = v2_plan.get("candidates") or []
    except Exception:
        v2_deployment_mode = ""
        v2_candidates = []
